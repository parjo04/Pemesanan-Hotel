...
$hotel_data = [
    ...
    'address' => 'Jl. Rumah Sakit Umum, Tasikmalaya',
    'rating' => 4.5,
    'price' => 389000,
    'id' => 3
];
...
if (isset($_POST['book_now'])) {
    ...
    $stmt_room = $conn->prepare("SELECT id FROM rooms WHERE hotel_id = ? AND is_available = 1 AND available_rooms > 0 LIMIT 1");
      ...
      foreach ($other_hotels as $hotel): ?>
        <div class="related-hotel-card">
          ...
          <div class="info">
            ...
            <a href="<?= isset($_SESSION['user']) ? $hotel['file'] : 'login.php?redirect=' . urlencode($hotel['file']) ?>" class="book-link">Pesan</a>
          </div>
        </div>
      <?php endforeach; ?>
    </div>
